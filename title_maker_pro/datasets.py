...
from title_maker_pro import custom_modeling_utils
from title_maker_pro import dictionary_definition
#import custom_modeling_utils
#import dictionary_definition
#import title_maker_pro.dictionary_definition
#import title_maker_pro.custom_modeling_utils
import re
import torch
import random
import stanza
...
class ParsedDictionaryDefinitionDataset(Dataset):
    ...
    def evaluate_creativity(cls, tokenizer, model, blacklist, num_to_generate, batch_size, max_length):
        input = tokenizer.encode(SpecialTokens.BOS_TOKEN, return_tensors="pt", max_length=max_length).to(model.device)
